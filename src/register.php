...
if ($Password == $Password1)
  {
$result = mysql_query("SELECT COUNT(*) AS count FROM ". $tblpre ."authors WHERE AuthorName = '$userName'",$connect);
while($row = mysql_fetch_array($result))
  {
    $count = $row['count'];
  }
$result1 = mysql_query("SELECT COUNT(*) AS count FROM ". $tblpre ."authors WHERE AuthorEmail = '$userEmail'");
...
if ($count == "0" && $emcount == "0")
  {
    $md5pwd = md5($Password);
    $RegisterForm = mysql_query("INSERT INTO ". $tblpre ."authors (AuthorId,AuthorName,AuthorEmail,AboutAuthor,Interests,Age,Password)
