...
//Set any variables
$ficId = $_REQUEST['fic'];
$result1 = mysql_query("SELECT valid FROM ". $tblpre ."fics WHERE fanFicId = '$ficId'",$connect);
...
if ($page == "list")
 {
   ...
   $result1 = mysql_query("SELECT COUNT(*) AS count FROM ". $tblpre ."fics WHERE valid = 'False'",$connect);
while($myrow1 = mysql_fetch_array($result1))
  {
   ...
   $result3 = mysql_query("SELECT * FROM ". $tblpre ."fics WHERE valid = 'False'",$connect);
