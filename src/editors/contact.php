...
if ($p == "submit")
   {
     ...
     mail("TheScripters.com <contact@thescripters.com>","Contact Made By $sitename","Contact has been attempted by $userName ($userEmail) at $sitename and has left the following message:\n\n$comment\n\nThank You,\n$sitename by TheScripters","From: $sitename Rep <$userEmail>");
...
echo "<center><table><tr><td align=\"center\">Adam:</td><td align=\"center\">Wayne:</td></tr><tr><td align=\"center\"><a href=\"http://edit.yahoo.com/config/send_webmesg?.target=ah15wm&.src=pg\"><img border=0 src=\"http://opi.yahoo.com/online?u=ah15wm&m=g&t=2\"></a></td><td align=\"center\"><a href=\"http://edit.yahoo.com/config/send_webmesg?.target=dmb1981&.src=pg\"><img border=0 src=\"http://opi.yahoo.com/online?u=dmb1981&m=g&t=2\"></a></td></tr></table><br>";
