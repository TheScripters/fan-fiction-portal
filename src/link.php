...
$Link = $_REQUEST['link'];
$sql = mysql_query("SELECT * FROM ". $tblpre ."links WHERE LinkId = '$Link'",$connect);
...
$HitsNew = $LinkHits + 1;
$sql1 = mysql_query("UPDATE ". $tblpre ."links SET Hits = '$HitsNew' WHERE LinkId = '$Link'",$connect);
?>
<html>
<head>
<meta http-equiv="Refresh" content="5; url=<?echo$Address?>">
<link rel="stylesheet" href="includes/ffp.css">
