  ...
  {// If the user is NOT logged in...
    ...
    if ($_SESSION['Logged_In'] == "True")
      {// Display logout link
        ...
        $s1 = mysql_query("SELECT * FROM kpfw_eplist WHERE Season = 'Season 1'");
        ...
        // Query for S2
        $s2 = mysql_query("SELECT * FROM kpfw_eplist WHERE Season = 'Season 2'");
        // Loop for S2
        ...
        // Query for S3
        $s3 = mysql_query("SELECT * FROM kpfw_eplist WHERE Season = 'Season 3'");
        // Loop for S3
...
if ($_GET['p'] == "edit")
  {
    ...
    echo "<input type=\"text\" name=\"EpNumber\" value=\"".$Edit['EpNumber']."\">&nbsp;&nbsp;<input type=\"text\" name=\"EpTitle\" value=\"".$Edit['EpTitle']."\"><br>\n";
    echo "<input type=\"text\" name=\"AirDate\" value=\"".$Edit['AirDate']."\">&nbsp;&nbsp;<input type=\"text\" name=\"ProdId\" value=\"".$Edit['ProdId']."\"><br>\n";
    echo "<input type=\"text\" name=\"season\" value=\"".$Edit['Season']."\"><br>\n";
    echo "<textarea rows=\"3\" cols=\"30\" name=\"EpDesc\">".$Edit['EpDesc']."</textarea><br>\n";
